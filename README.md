...
ユーザーがこのサービスをどのように利用できて、それによってどんな価値を得られるかを簡単に説明してください。
 - 音楽の練習をしたい人が練習施設を探す際にマップを用いたり、駅名や住所を検索フォームに入力して練習場所を探す。
   ...
   → いちいち検索サイトで「〇〇(地域名) スタジオ」「⚪︎⚪︎(地域名) カラオケ」など検索しなくてもこのアプリ一つで検索すれば出てくる。
...
独自性の強いサービスの場合、このサービスの推しとなるポイントを教えてください。
 - 音楽演奏可能施設に特化した検索アプリやまとめサイト等は存在しない。
   インスタベースといったレンタルスペースの掲載、予約サイトは存在するものの、演奏活動を行うユーザー目線の情報掲載にはなっていない。
   施設の情報だけでなく、口コミ演奏活動を行うユーザー視点での情報共有ができる。そういった点で差別化が図れている。
 - カラオケとスタジオ、公共の施設、レンタルスペースが全てまとめて検索することができる。
...
| gem            | sorcery(ユーザー登録,管理), carrierwave(画像投稿), <br> turbo-rails(ブックマーク、マップ), google maps(GoogleMapsAPI) | 